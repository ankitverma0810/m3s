...
<?php
	if(isset($_POST['submit']))
	{
		...
		if($subcategory->save())
		{
			$session->message("subcategory updated Successfully", "success");
			redirect_to('view-subcategory.php');
		}
		else
		{
			$message = join("<br />", $subcategory->errors);
		}
	}
?>
...
<div class="content">
  ...
  <form action="edit-subcategory.php?subid=<?php echo $subcategory->id; ?>" method="post">
  <table width="100%" cellpadding="7" cellspacing="1" class="table">
    ...
    <tr>
      ...
      <td width="76%"> <input name="title" type="text" class="textfield" value="<?php echo $subcategory->title; ?>" /> </td>
    </tr>
    
    <tr valign="top">
      <td width="24%"> Meta Keywords: </td>
      <td width="76%"> <textarea name="keywords" cols="" rows="" class="textarea"><?php echo $subcategory->meta_keywords; ?></textarea> </td>
    </tr>
    
    <tr valign="top">
      <td width="24%"> Meta Description: </td>
      <td width="76%"> <textarea name="description" cols="" rows="" class="textarea"><?php echo $subcategory->meta_description; ?></textarea> </td>
    </tr>

    <tr>
      <td width="24%"> Status: </td>
      <td width="76%"> 
      	<input name="status" type="radio" value="1" class="radio" <?php if($subcategory->status==1) {echo "checked";} ?>/> <p> Visible </p>
        <input name="status" type="radio" value="0" class="radio" <?php if($subcategory->status==0) {echo "checked";} ?> /> <p> Not Visible </p>
      </td>
    </tr>
    ...
    <tr>
      <td width="24%">&nbsp;  </td>
      <td width="76%"> 
      	<input name="submit" type="submit" class="submit" value="UPDATE SUBCATEGORY" />
