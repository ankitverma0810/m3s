...
<?php
	...
	$per_page = 12;
	$total_count = Orders::count_all_featured();
	...
	if(isset($_POST['active']))
	{
		...
		if(empty($_POST['checkbox']))
		{
			...
			redirect_to("featured-ads.php");
		}
		else
		{			
			$activate->checkbox = $_POST['checkbox'];			
			if($activate->update_multiple(2, 'featured_status'))
			{
				$session->message("Ad Featured", "success");
				redirect_to("featured-ads.php");
			}
		}
	}
	if(isset($_POST['not-active']))
	{
		...
		else
		{
			...
			if($deactivate->update_multiple(1, 'featured_status'))
			{
				$session->message("Ad Not Featured", "success");
				redirect_to("featured-ads.php");
			}
		}
	}
	if(isset($_POST['renew']))
	{
		...
		{			
			...
			if($renew->update_multiple(3, 'featured_status'))
			{
...
<div class="content">
  ...
  <form action="featured-ads.php" method="post">  
  <table width="100%" cellpadding="7" cellspacing="1" class="table">
    ...
    <?php
		...
		$sql = "SELECT * FROM mh_orders WHERE ad_type = 'featured'";
		...
		foreach($orders as $order)
		{
			...
			echo "<tr bgcolor='$color'>";
			  ...
			  echo "<td> <a href='view-ad.php?ad_id=$classified->id&tablename=$order->tablename&user_id=$order->user_id&orderid=$order->order_id&page=$page&type=featured'> view </a></td>";
			echo "</tr>";
		}
	?>
    ...
    <tr>
    	<td colspan="8">
        	<input name="active" type="submit" class="submit" value="Featured" />
            <input name="not-active" type="submit" class="submit" value="Not Featured" />
  ...
  <div class="pagination">
	  ...
	  <?php
        ...
        {		
            ...
            {
                echo "<li><a href=\"featured-ads.php?page=";
            ...
            //for($i=1; $i <= $pagination->total_pages(); $i++)
            {
                ...
                {
                    echo "<li> <a href=\"featured-ads.php?page={$i}\">{$i}</a> </li>";
                }
            }
